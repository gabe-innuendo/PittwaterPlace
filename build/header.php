...
<html class="no-js" lang="">
    <head>
        ...
        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css?family=Libre+Baskerville:700|Montserrat:200,200i,400,400i,700,700i" rel="stylesheet">
        ...
        <header class="main-header">
            <div class="flexGridRow">
                <div class="cell cell--oneQuarter cell-header-opening-hours">
                    ...
                    <aside class="trading-hours-popup">
                        <article class="trading-hours-copy">
                            <div class="close">
                            ...
                            <p>For more detailed trading hours please visit our <a href="">store directory.</a></p>
                        </article>
                    </aside>
                </div>
